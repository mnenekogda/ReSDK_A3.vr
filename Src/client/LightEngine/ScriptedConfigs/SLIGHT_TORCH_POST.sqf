...
regScriptEmit(SLIGHT_TORCH_POST)
	[
		"lt",
		...
		["setLightAttenuation",[0,0,0,0,20,25]]
	]
	,[
		"pt",
		[["loop_sound",["fire\campfire",null,10,3]]],
		_emitAlias("Огонь")
		["linkToLight",[0,0,0.85]],
		["setParticleParams",[["\A3\data_f\ParticleEffects\Universal\Universal.p3d",16,10,32,1],"","Billboard",3,0.3,[0,0,0],[0,0,0.6],0,0.05,0.04,0.05,[0.34,0],[[1,1,1,-100],[1,1,1,-100],[0,0,0,0]],[1],0,0,"","","",0,false,0,[[0,0,0,0]]]],
	...
	,[
		...
		_emitAlias("Дым")
		["linkToLight",[0,0,0.85]],
		["setParticleParams",[["\A3\data_f\ParticleEffects\Universal\Universal.p3d",16,7,48,1],"","Billboard",1,5,[0,0,0],[0,0,0.6],0,0.05,0.04,0.1,[0.15,1.5],[[0.1,0.1,0.1,0.06],[0.2,0.2,0.2,0.04],[0.2,0.2,0.2,0.02],[0.3,0.3,0.3,0.01],[0.4,0.4,0.4,0.005]],[1.5,0.5],0.4,0.02,"","","",0,false,-1,[]]],
	...
	,[
		...
		["linkToLight",[0,0,0.85]],
		["setParticleParams",[["\A3\data_f\ParticleEffects\Universal\Refract.p3d",1,0,1,0],"","Billboard",1,2,[0,0,0],[0,0,0.6],0,0.05,0.04,0.05,[0.2,1.8,2.6],[[0.6,0.6,0.6,0.2],[0.7,0.7,0.7,0.2],[0.8,0.8,0.8,0.1],[1,1,1,0]],[1.5,0.5],0.4,0.09,"","","",0,false,0,[[0,0,0,0]]]],
